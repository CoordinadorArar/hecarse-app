...
(function () {
  ...
  function cerrarSesionPorInactividad() {
    Toast.fire({
      icon: 'warning',
      title: 'Sesión expirada por inactividad. Favor ingrese de nuevo.'
    });
...
document.addEventListener('DOMContentLoaded', function(){
    // Función para mantener dropdowns activos
    function keepActiveDropdowns() {
      const currentUrl = window.location.href;
       
      // Buscar todos los enlaces activos en submenús
      const activeLinks = document.querySelectorAll('.collapse .nav-link');
      ...
      activeLinks.forEach(link => {
        ...
        if (currentUrl === link.href || currentUrl.includes(link.getAttribute('href'))) {
          ...
          // Encontrar el dropdown padre
          const parentCollapse = link.closest('.collapse');
          if (parentCollapse) {
            // Mantener el dropdown abierto
            parentCollapse.classList.add('show');
            
            // Encontrar el botón toggle correspondiente
