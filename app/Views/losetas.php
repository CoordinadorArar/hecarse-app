...
<main>
    <div class="px-4 py-1 my-5 text-center">
        <img class="d-block mx-auto mb-4" src="public/assets/img/logo_hecarse.png" alt="Hecarse" width="300">
    ...
    <div class="row row-cols-1 mb-3 text-center d-flex justify-content-center" id="losetas">
        <?php foreach ($losetas as $loseta): ?>
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 px-5">
                <div class="card mb-4 rounded-3 shadow-sm border-primary card-animated background-card"
                    onclick="ingresarModulo('<?= esc($loseta['Ruta']) ?>')">
